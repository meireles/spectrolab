...
# Simple spectra plot
par(mfrow = c(1, 3))
plot(acer_spectra, lwd = 0.75, lty = 1, col = "grey25", main = "All Spectra")

# Stand along quantile plot
plot_quantile(acer_spectra, total_prob = 0.8, main = "80% spectral quantile", col = rgb(1, 0, 0, 0.5), lwd = 0.5, border = TRUE)
...
plot_quantile(acer_spectra, total_prob = 0.8, col = rgb(1, 0, 0, 0.25), border = FALSE, add=TRUE)
