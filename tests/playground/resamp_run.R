...
r_sc1 = resample_spectrum(wavelengths = b, reflectance = s, new_wavelengths = n, fwhm = r1)
r_sc2 = resample_spectrum(wavelengths = b, reflectance = s, new_wavelengths = n, fwhm = r2)
r_sc3 = resample_spectrum(wavelengths = b, reflectance = s, new_wavelengths = n, fwhm = r3)
